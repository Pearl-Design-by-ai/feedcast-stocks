...
export default async function PortfolioLabPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-gray-100 p-6 md:p-8">
            ...
            <ScoreMethodology
                className="mb-6"
                methodology="Each holding is run through a 5-step value framework — current position, growth thesis, the one thing holding it back (capex / FCF / ROIC), cycle & valuation, and an overall judgment — then the basket is read as a whole for a Health Score, cycle exposure, concentration and diversification ideas. The per-name and portfolio reads are generated by FeedCast AI and grounded in price + fundamentals."
