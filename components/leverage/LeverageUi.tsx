        ...
        <section className="flex flex-col gap-4">
            <div>
                ...
                <p className="mt-1 max-w-3xl text-sm text-gray-400">
                    ...
                    versus simply buying and holding the plain 1x, and versus holding the 3x with no timing at all. Net of ~{bt.costBps} bps per {bt.rebal} rebalance; gross of taxes.
                </p>
