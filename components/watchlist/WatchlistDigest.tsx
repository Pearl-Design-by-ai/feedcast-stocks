    ...
    return (
        <section className="rounded-xl border border-gray-800 bg-gray-900/40 p-4">
            <div className="mb-3 flex flex-wrap items-center gap-2">
                ...
                <span className="text-xs text-gray-500">FeedCast AI · from your stocks’ headlines</span>
            </div>
            ...
            <p className="mt-3 text-[11px] text-gray-600">
                Generated by FeedCast AI from news headlines — informational only, not investment advice.
            </p>
        </section>
    );
}
